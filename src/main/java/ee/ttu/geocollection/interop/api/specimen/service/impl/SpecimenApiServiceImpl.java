...
//        return apiService.searchRawEntities(SPECIMEN_IMAGE_TABLE, 2,1, new SortField(), requestParams); EDIT 21.12.2017
    ...
    public Map findRawSpecimenImageById(Long id) {
        String requestParams = FluentGeoApiDetailsBuilder.aRequest()
                .id(id)
//                .returnCustomField(ApiFields.SPECIMENIDENTIFICATION__TAXON__TAXON)
//                .returnCustomField(ApiFields.SPECIMENIDENTIFICATION__TAXON_ID)
//                .returnCustomField(ApiFields.SPECIMENIDENTIFICATION__NAME)
//                .returnCustomField(ApiFields.SPECIMENIDENTIFICATIONGEOLOGIES__NAME)
//                .returnCustomField(ApiFields.SPECIMENIDENTIFICATIONGEOLOGIES__NAME_EN)
